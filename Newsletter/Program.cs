...
{
    private readonly string _databaseFile = "subscriptions.json";
    private readonly string _emailOutboxFolder = "email-outbox";

    public string Subscribe(string emailInput)
    {
        ...
        var existing = subscriptions
            .FirstOrDefault(s => s.Email == email.Value);
    ...
    private void SendEmail(EmailToSend email)
    {
